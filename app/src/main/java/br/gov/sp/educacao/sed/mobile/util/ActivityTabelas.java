...
public class ActivityTabelas extends Activity implements OnItemClickListener {
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new BdSED(ActivityTabelas.this);

        mainscrollview = new ScrollView(ActivityTabelas.this);
        ...
        mainLayout = new LinearLayout(ActivityTabelas.this);
        ...
        final Button submitQuery = new Button(ActivityTabelas.this);
        ...
        final TextView help = new TextView(ActivityTabelas.this);
        ...
        final Spinner spinnertable =new Spinner(ActivityTabelas.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(ActivityTabelas.this);
        previous = new Button(ActivityTabelas.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(ActivityTabelas.this);
        next.setText("Next");
        ...
        tvmessage =new TextView(ActivityTabelas.this);
        ...
        final Button customQuery = new Button(ActivityTabelas.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(ActivityTabelas.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(ActivityTabelas.this,
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if(!isFinishing()){
                                                ...
                                                new AlertDialog.Builder(ActivityTabelas.this)
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    final ScrollView addrowsv =new ScrollView(ActivityTabelas.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(ActivityTabelas.this);
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(ActivityTabelas.this);
                        ...
                        {
                            LinearLayout cell = new LinearLayout(ActivityTabelas.this);
    ...
    public void updateDeletePopup()
    {
        ...
        final RelativeLayout lp = new RelativeLayout(ActivityTabelas.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv =new ScrollView(ActivityTabelas.this);
        LinearLayout lcrud = new LinearLayout(ActivityTabelas.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(ActivityTabelas.this,
